...
class TestTiming(TestCase):
    @patch("common.basic.functional.timing.time.time")
    @patch("common.basic.functional.timing.uuid.uuid4")
    @patch("common.basic.functional.timing.threading.current_thread")
