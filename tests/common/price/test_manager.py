...
from common.price import daos, data, manager, models


@test_utils.cls_test_database(models.Price)
class TestPriceManager(TestCase):
    @patch("common.price.manager._registry")
    @patch("common.price.manager.coin_manager")
    @patch("common.price.manager.daos")
