...
from common.provider import exceptions as provider_exceptions
from common.transaction import daos, data, manager, models


@test_utils.cls_test_database(models.TxAction)
class TestTransactionManager(TestCase):
    @patch("common.transaction.manager.coin_manager")
    @patch("common.transaction.manager.provider_manager")
    ...
    @patch("common.transaction.manager.provider_manager")
    @patch("common.transaction.manager.coin_manager")
    @patch("common.transaction.manager.time")
