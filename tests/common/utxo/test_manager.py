...
from common.utxo import daos, data, manager, models
...
class TestUTXOManager(TestCase):
    ...
    @patch("common.utxo.manager.provider_manager.search_utxos_by_address")
    @patch("common.utxo.manager.coin_manager.get_chain_info")
