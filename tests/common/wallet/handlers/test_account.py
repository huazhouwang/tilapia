...
from common.wallet.handlers import account
...
class TestAccountChainModelHandler(TestCase):
    def setUp(self) -> None:
        ...
        patch_coin_manager = patch("common.wallet.handlers.account.coin_manager")
        patch_provider_manager = patch("common.wallet.handlers.account.provider_manager")
        patch_daos = patch("common.wallet.handlers.account.daos")
